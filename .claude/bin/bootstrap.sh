...
if [[ $ERRORS -eq 0 ]]; then
  ...
  echo "  4. Create GitHub labels (run once):"
  echo "     for l in dod:pending#FBCA04 dod:ac#0E8A16 dod:milestone#1D76DB \\"
  echo "              dod:confirmed#5319E7 dod:rejected#D93F0B dod:needs-more#FEF2C0 \\"
  echo "              gate:brief#C5DEF5 gate:roadmap#0075CA gate:active#0E8A16 \\"
  echo "              gate:milestone#1D76DB gate:project#5319E7 gate:closed#000000 \\"
  echo "              gate:cancelled#B60205 gate:done#5319E7; do"
  echo "       gh label create \"\${l%%#*}\" --color \"\${l##*#}\" --force; done"
